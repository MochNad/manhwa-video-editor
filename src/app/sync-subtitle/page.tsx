...
export default function SyncSubtitle() {
  return (
    <div className="min-h-screen h-full w-full flex-1 flex flex-col items-center justify-center text-center space-y-2">
      ...
      <div className="space-y-1">
        <h3 className="text-base font-medium text-foreground">Halaman Sinkronisasi Subtitle</h3>
        <p className="text-xs text-muted-foreground max-w-sm">
          Dalam pengembangan 🍜.
        </p>
      </div>
      <div className="px-3 py-1 bg-muted/30 rounded border border-dashed border-muted-foreground/30">
        <p className="text-xs text-muted-foreground">/sync-subtitle</p>
      </div>
    </div>
  );
}